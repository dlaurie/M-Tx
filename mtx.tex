...
\def\mtxtexversion{0.61a}
\def\mtxtexdate{16 January 2016}
\let\:=\relax
...
\input pmx
\def\pmxneeded{2.71}
\ifdim\pmxversion pt<\pmxneeded pt\immediate\write16{ }
\message{! Requires PMX Version \pmxneeded. Please upgrade.}
\end{document}\fi
